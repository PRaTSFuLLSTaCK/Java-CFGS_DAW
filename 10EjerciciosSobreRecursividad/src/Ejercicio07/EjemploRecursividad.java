...
Si el caso base no se cumple, entonces se resta el dividendo y el divisor. 
A este resultado se le vuelve a restar el divisor. 
Este proceso se repite hasta que se llega al caso base, es decir, cuando el 
resultado obtenido al restar sea menor que el divisor.
...
public class EjemploRecursividad {
	...
	private static int resto(int i, int b) {
