...
//Una forma alternativa de hacer este programa es creando dos objetos 
//Character a partir de los caracteres que se han leído y compararlos utilizando el método equals

import java.io.*;
public class condicional1_4_2 {
