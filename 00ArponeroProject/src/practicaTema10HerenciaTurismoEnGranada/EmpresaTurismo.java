...
public class EmpresaTurismo {
	...
	/** The tickets. */
	private static ArrayList<Ticket> tickets;;//DECLARACION DEL ARRAY TICKETS
	...
	private static void borrarTicket() {
		...
		int posicion = tickets.indexOf(new Ticket(idTicket));//SEGUNDO PASO 
	...
	private static void imprimirYGuardar() {
		...
		tickets.add(tmp);//GUARDAMOS EL TICKET
