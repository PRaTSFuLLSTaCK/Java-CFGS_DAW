...
public class teclado {
	...
	public static int leer_entero (String mensaje, int min, int max) {
		...
		do {
			...
			if (n < min || n > max) { //Se cumple o no se cumple la condici�n de que n sea mayor o menor que...?
				System.out.println("Debe introducir un n�mero entre "+ min + " y " + max);
			}else {
				return n;
			}
		} while (true); // Se cumple la condici�n?
	}
